          ...
          <div className='space-y-6'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-4'>
              <div className='flex rounded-md overflow-hidden border border-gray-300'>
                ...
                />
                <button
                  className='bg-[#D52727] hover:bg-[#B02121] px-4 flex items-center justify-center'
                  onClick={() => {
                    const q = (searchQuery || "").trim();
                    const search = q ? `?q=${encodeURIComponent(q)}` : "";
                    navigate(`/paper${search}`);
            ...
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-4'>
              <button
                className='w-full bg-[#D52727] hover:bg-[#B02121] text-white font-medium py-2 px-4 rounded-md flex items-center justify-center'
                onClick={async () => {
                  try {
