...
import FindProject from "../components/patent/FindPatent";
...
function SidebarSection({ title, items }) {
  ...
  return (
    <div className="mb-6">
      <h3 className="font-medium text-sm sm:text-sm mb-2">{title}</h3>
      ...
      {items.length > 5 && (
        <button
          ...
          className="text-blue-600 text-sm sm:text-sm mt-2"
        >
    ...
    <section className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-6 sm:py-10">
        ...
        <div className="flex flex-col md:flex-row gap-6 lg:gap-8">
          ...
          <h2 className="font-semibold text-base sm:text-base mb-4">Filters for Patent</h2>
          ...
          {/* Summary row */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b pb-3 mb-6 gap-2">
            <p className="text-sm text-gray-600">
              1 - {sortedProjects.length} out of {dummyProjects.length} results
            </p>
            <div className="flex items-center gap-3 sm:gap-5 text-sm w-full sm:w-auto">
              <button
          ...
          <div className="space-y-6">
            {sortedProjects.map((project, idx) => (
              <article key={idx} className="border-b pb-4">
                <h2 className="font-semibold text-lg sm:text-lg text-gray-900 mb-1">{project.title}</h2>
